# `@diotoborg/nobis-mollitia` <sup>[![Version Badge][npm-version-svg]][package-url]</sup>
...
```sh
npm install eslint @diotoborg/nobis-mollitia --save-dev
```
...
If you are using the [new JSX transform from React 17](https://reactjs.org/blog/2020/09/22/introducing-the-new-jsx-transform.html#removing-unused-react-imports), extend [`react/jsx-runtime`](https://github.com/diotoborg/nobis-mollitia/blob/c8917b0885094b5e4cc2a6f613f7fb6f16fe932e/index.js#L163-L176) in your eslint config (add `"plugin:react/jsx-runtime"` to `"extends"`) to disable the relevant rules.
...
**Note**: These configurations will import `@diotoborg/nobis-mollitia` and enable JSX in [parser options](https://eslint.org/docs/user-guide/configuring/language-options#specifying-parser-options).
...
The default export of `@diotoborg/nobis-mollitia` is a plugin object.

```js
const react = require('@diotoborg/nobis-mollitia');
...
- `@diotoborg/nobis-mollitia/configs/all`
- `@diotoborg/nobis-mollitia/configs/recommended`
- `@diotoborg/nobis-mollitia/configs/jsx-runtime`

If your eslint.config.js is ESM, include the `.js` extension (e.g. `@diotoborg/nobis-mollitia/recommended.js`). Note that the next semver-major will require omitting the extension for these imports.

**Note**: These configurations will import `@diotoborg/nobis-mollitia` and enable JSX in [`languageOptions.parserOptions`](https://eslint.org/docs/latest/user-guide/configuring/configuration-files-new#configuration-objects).
...
```js
const reactRecommended = require('@diotoborg/nobis-mollitia/configs/recommended');
...
💼 [Configurations](https://github.com/diotoborg/nobis-mollitia/#shareable-configs) enabled in.\
🚫 [Configurations](https://github.com/diotoborg/nobis-mollitia/#shareable-configs) disabled in.\
🏃 Set in the `jsx-runtime` [configuration](https://github.com/diotoborg/nobis-mollitia/#shareable-configs).\
☑️ Set in the `recommended` [configuration](https://github.com/diotoborg/nobis-mollitia/#shareable-configs).\
...
- Rules of Hooks: [@diotoborg/nobis-mollitia-hooks](https://github.com/facebook/react/tree/master/packages/@diotoborg/nobis-mollitia-hooks)
- JSX accessibility: [eslint-plugin-jsx-a11y](https://github.com/jsx-eslint/eslint-plugin-jsx-a11y)
- React Native: [@diotoborg/nobis-mollitia-native](https://github.com/Intellicode/@diotoborg/nobis-mollitia-native)

## License

`@diotoborg/nobis-mollitia` is licensed under the [MIT License](https://opensource.org/licenses/mit-license.php).

[npm-url]: https://npmjs.org/package/@diotoborg/nobis-mollitia
[npm-image]: https://img.shields.io/npm/v/@diotoborg/nobis-mollitia.svg

[status-url]: https://github.com/diotoborg/nobis-mollitia/pulse
[status-image]: https://img.shields.io/github/last-commit/jsx-eslint/@diotoborg/nobis-mollitia.svg

[tidelift-url]: https://tidelift.com/subscription/pkg/npm-@diotoborg/nobis-mollitia?utm_source=npm-@diotoborg/nobis-mollitia&utm_medium=referral&utm_campaign=readme
[tidelift-image]: https://tidelift.com/badges/package/npm/@diotoborg/nobis-mollitia?style=flat

[package-url]: https://npmjs.org/package/@diotoborg/nobis-mollitia
[npm-version-svg]: https://versionbadg.es/jsx-eslint/@diotoborg/nobis-mollitia.svg

[actions-image]: https://img.shields.io/endpoint?url=https://github-actions-badge-u3jn4tfpocch.runkit.sh/jsx-eslint/@diotoborg/nobis-mollitia
[actions-url]: https://github.com/diotoborg/nobis-mollitia/actions
